...
$query=mysqli_query($con, "insert into team(first_name,last_name, email, idea,ProfilePic) value('$first_name','$last_name', '$email',  '$idea','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		...
		<div class="form-group">
            <textarea class="form-control" name="idea" placeholder="Idea about the website" required="true"></textarea>
        </div>  
             <div class="form-group">
	...
	<div class="text-center">View Already Inserted Data!!  <a href="indexteam.php">View</a></div>
</div>
</body>
</html>